...
Key offenders:
- email.py:43 — `AIPASS_ROOT = Path.home() / "aipass_core"`
- central_writer.py:54-57 — 4 instances (AI_CENTRAL_DIR, BRANCH_REGISTRY)
- dispatch/daemon.py — 4 instances
- dispatch/wake.py — 3 instances
- email/delivery.py:71 — hardcoded `Path("/home/aipass/BRANCH_REGISTRY.json")`
- registry/read.py:41 — hardcoded `Path("/home/aipass/BRANCH_REGISTRY.json")`
