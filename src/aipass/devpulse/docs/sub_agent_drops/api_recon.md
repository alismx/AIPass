...
**Other:**
- json_handler.py:29 — `API_ROOT = Path.home() / "aipass_core" / "api"` (import-time)
...
## Key Insight
23 of 31 Path.home() issues are in **Telegram handlers** — this is Dev-Pass infrastructure. DPLAN-047 recommends stripping it for v1.0 (Option B).
